...
var phanterwebSvgs = new (function() {
    ...
    this.update=function(){
        for (var key in this.icons) {
            phanterwebQuery(".phanterwebsvg."+key).html(this.icons[key])
        };  
    }
    this.update()
})();
...
var phanterwebGallery = new (function(){
    ...
    this._config = {
            ...
            imgButton:"<i class=\"phanterwebsvg upload-cloud\"></i>",
        };
    this._messages = {
